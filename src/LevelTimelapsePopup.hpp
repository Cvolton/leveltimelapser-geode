...
protected:
    ...
    bool setup(GJGameLevel* level) override {
        ...
        m_objects = utils::string::split(decodedLevelString, ";");
    ...
    void timelapseLevel(GJGameLevel* ogLevel) {
        ...
        static_cast<LTLevelEditorLayer*>(editor->getChildByType<LevelEditorLayer>(0))->initTimelapse(m_objects, this->delayPerObject());
    }
